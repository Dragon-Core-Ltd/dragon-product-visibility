...
class Product_Metabox {
	...
	private function __construct() {
		...
		add_action( 'woocommerce_process_product_meta_variable', array( $this, 'save_product_data' ) );
	}
	...
	public function add_product_tab( array $tabs ): array {
		$tabs['visibility_restrictions'] = array(
		...
		<div id="visibility_restrictions_data" class="panel woocommerce_options_panel">
			...
			<div class="options_group dpv-restrictions-panel" style="<?php echo ( 'none' === $restriction_mode ) ? 'display:none;' : ''; ?>" data-mode="<?php echo esc_attr( $restriction_mode ); ?>">
				...
				<div class="dpv-section">
					...
					<p class="description dpv-customers-desc dpv-whitelist-text" <?php echo ( 'blacklist' === $restriction_mode ) ? 'style="display:none;"' : ''; ?>>
						<?php esc_html_e( 'Search and select individual customers who CAN view this product.', 'dragon-product-visibility' ); ?>
					</p>
					<p class="description dpv-customers-desc dpv-blacklist-text" <?php echo ( 'blacklist' !== $restriction_mode ) ? 'style="display:none;"' : ''; ?>>
				...
				<div class="dpv-section">
					...
					<p class="description dpv-roles-desc dpv-whitelist-text" <?php echo ( 'blacklist' === $restriction_mode ) ? 'style="display:none;"' : ''; ?>>
						<?php esc_html_e( 'Select user roles that CAN view this product.', 'dragon-product-visibility' ); ?>
					</p>
					<p class="description dpv-roles-desc dpv-blacklist-text" <?php echo ( 'blacklist' !== $restriction_mode ) ? 'style="display:none;"' : ''; ?>>
				...
				<div class="dpv-info-box dpv-whitelist-text" <?php echo ( 'blacklist' === $restriction_mode ) ? 'style="display:none;"' : ''; ?>>
					<p>
				...
				<div class="dpv-info-box dpv-blacklist-text" <?php echo ( 'blacklist' !== $restriction_mode ) ? 'style="display:none;"' : ''; ?>>
					<p>
